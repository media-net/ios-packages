Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '14.0'
  s.source           = { :http => 'https://github.com/media-net/ios-packages/releases/download/v0.0.23/MediaNetRendererAdSDK.xcframework.zip' }
  ...
  s.resource_bundles = { 'MediaNetRendererAdSDKResources' => ['MediaNetRendererAdSDKResources/*'] }
