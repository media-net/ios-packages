Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/media-net/ios-packages/releases/download/v0.0.13/MediaNetRendererCore.xcframework.zip' }
  s.prepare_command  = "curl -fsSL -o omsdk.zip 'https://github.com/media-net/ios-packages/releases/download/v0.0.13/OMSDK_Static_Medianet.xcframework.zip' && unzip -qo omsdk.zip && rm -f omsdk.zip"
