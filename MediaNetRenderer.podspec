Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '13.0'
  s.source           = { :http => 'https://github.com/media-net/ios-packages/archive/refs/tags/v0.0.7.zip' }
  s.dependency 'MediaNetRendererCore',   '0.0.7'
  s.dependency 'MediaNetRendererPrebid', '0.0.7'
end
