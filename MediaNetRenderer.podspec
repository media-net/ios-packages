Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '14.0'
  s.source           = { :http => 'https://github.com/media-net/ios-packages/archive/refs/tags/v0.0.18.zip' }
  s.dependency 'MediaNetRendererCore',   '0.0.18'
  s.dependency 'MediaNetRendererPrebid', '0.0.18'
end
